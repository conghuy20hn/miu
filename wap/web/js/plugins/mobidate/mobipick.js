...
$.widget( "sustainablepace.mobipick", $mobile.widget, {
	...
	_markup_trailer: "</ul><ul class='mobipick-buttons'><li><a class='mobipick-set'>Set</a></li><li><a class='mobipick-cancel' style='border-right: 1px solid #ccc;'>Cancel</a></li><li><a class='reset'>Clear</a></li></ul></div>",
